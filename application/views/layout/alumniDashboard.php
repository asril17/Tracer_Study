        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        <a class="nav-link" href="<?= site_url('alumniPage') ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Dashboard
                        </a>
                        <a class="nav-link" href="<?= site_url('alumniProfile') ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-user-circle"></i></div>
                            Profile
                        </a>
                        <a class="nav-link" href="<?= site_url('alumniInfoLowongan') ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-user-circle"></i></div>
                            Info Lowongan
                        </a>
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="<?= site_url('kuisioner') ?>">
                                    <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                    Kuisioner
                                </a>
                                ...
                                <a class="nav-link" href="<?= site_url('lowongan') ?>">
                                    <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                    Lowongan
                                </a>
                            </nav>
